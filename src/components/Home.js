    ...
    return (
        ...
        <div>
            ...
            <div className="directions">
                <h3>Directions</h3>
                <p className="home_text dir">This tool consists of two main functionalities: a skill search and a resume analysis.</p>
                <p className="home_text dir">Skill search: You can choose a job you are interested in from our selection of 18 engineering job titles in 4 engineering job categories to learn about the top most commonly sought after communication skills for that job.</p>
                <p className="home_text dir">OR</p>
                <p className="home_text dir">Resume analysis: You can paste in the content of your resume along with a job title or a job description, and we will give you a score reflecting how successful your resume is in showing your communication skills as well as the most required communication skills for that job.</p>

...
function About() {
    ...
    const rs_bio = "I am a Senior Electrical & Computer Engineering major in the College of Engineering. I have prior internship experience in Data Science and Cloud Analytics, and will be an MEng student following my graduation in May 2022. Outside of school, I play badminton and tennis."
    const nm_bio = "I am a Senior Computer Science major in the College of Engineering. I have prior internship experience in Data Science and Software Engineering, and will be a Software Engineer following my graduation in May 2022. Outside of school, I play golf and Squash."
    ...
    return <div>
        ...
        <div className="team_members">
            <div className="row row1">
                ...
                <Member name="Ronin Sharma" pic={rs_headshot} title="Frontend & Backend Devloper" bio={rs_bio} info="ECE '22" />
                <Member name="Paul Beck" pic={pb_headshot} title="Frontend & Backend Devloper" bio={pb_bio} info="AEP '22" />
